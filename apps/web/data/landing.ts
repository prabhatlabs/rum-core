export const hero = {
    ...
    herodesc:
        "Go beyond Lighthouse scores. Monitor real-world interactions across every ISP, region, and device. Get deep visibility into broken APIs and slow page loads with one simple script.",

    secondarytext: "Performance monitoring that doesnt cost you performance.",
    secondarydesc:
        "A ~5kb heartbeat for your web app. Capture Web Vitals, API latencies, and user environment data with zero overhead—enriched at the edge and built for the modern developer.",
};
...
export const howto = {
    ...
    subhead:
        "Stop wrestling with complex configurations. rum-core is a drop-in solution that works with any framework.",
    steps: [
...
export const bottomhero = {
    ...
    herodesc:
        "Lab tests hide real-world lag. rum-core captures the truth of every ISP, every 3G connection, and every regional outage. Stop optimizing for robots and start building for people.",
};
