...
export const pageVitals = sqliteTable('page_vitals', {
    ...
    index('idx_page_vitals_project_timestamp').on(t.project_key, t.timestamp),
    ...
    index('idx_page_vitals_project_device').on(t.project_key, t.device_type),
